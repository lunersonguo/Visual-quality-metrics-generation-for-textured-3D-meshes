...
\end{equation}
where $n$ is the number of scales (3 in our study). Finally, Minkowski pooling method was used to pool all the local distortion measures into one global socre $\Delta{G}$