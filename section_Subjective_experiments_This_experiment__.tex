...
\end{equation}
where $N$ is the total  vertices number on $M_d$, typical $p$ values are from 2 to 4, and through our trails and comparisons, we determined to use 2(Mean Root Square).